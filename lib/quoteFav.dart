...
class QuoteFav extends StatefulWidget {
  @override
  _QuoteFavState createState() => _QuoteFavState();
}

class _QuoteFavState extends State<QuoteFav> {
  var getQuote;
  ...
  Widget doQuotes(BuildContext context,int index){
    ...
    return Padding(
      ...
      child: favQuotes.length>0? favQuotes.contains(index)? InkWell(
        child: Container(
              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Text(favQuotes.contains(index)?'Sudah disimpan':'Simpan',style: TextStyle(color: Colors.black,fontSize: 18,fontWeight: FontWeight.w500),),
                    SizedBox(width: w*0.02,),
      ...
      Container(
        height: h*0.5,
        child: Center(child: Text('Tiada kata hikmah disukai',style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.w400),),),
      ),
    );
  }
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: <Widget>[
                        Text('Kata Hikmah Disukai',style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.w500),),
                      ],
                    ),
                  ),
                ],
                        ...
                        if (snap.hasData){
                          ...
                          return Expanded(
                            child: ListView.builder(
                              itemCount: favQuotes.length>0? getQuote.length:1,
